...
class DataLoader(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return torch.FloatTensor(code).to(torch.int64), torch.FloatTensor(age).to(torch.int64), torch.FloatTensor(gender).to(torch.int64), torch.FloatTensor(
            ethni).to(torch.int64), torch.FloatTensor(ins).to(torch.int64), \
