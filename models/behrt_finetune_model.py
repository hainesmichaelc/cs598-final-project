...
class BertEmbeddings(nn.Module):
    ...
    def forward(self, word_ids, age_ids, gender_ids, ethnicity_ids, ins_ids, posi_ids=None, seg_ids=None,
                age=False):
        ...
        embeddings = word_embed + age_embed + gender_embed + ethnicity_embed + ins_embed + segment_embed + posi_embeddings
        #embeddings = self.temporal_layer(torch.cat((age_embed, embeddings), dim=2))
...
class BertModel(Bert.modeling.BertPreTrainedModel):
    ...
    def forward(self, input_ids, age_ids, gender_ids, ethnicity_ids, ins_ids, posi_ids=None, seg_ids=None,
                attention_mask=None,
        ...
        embedding_output = self.embeddings(input_ids, age_ids, gender_ids, ethnicity_ids, ins_ids, posi_ids,
                                           seg_ids)
...
class BertForEHR(Bert.modeling.BertPreTrainedModel):
    ...
    def forward(self, input_ids, age_ids, gender_ids, ethnicity_ids, ins_ids, posi_ids=None, seg_ids=None,
        ...
        _, pooled_output = self.bert(input_ids, age_ids, gender_ids, ethnicity_ids, ins_ids, posi_ids,
...
class DataLoader(Dataset):
    ...
    def __getitem__(self, index):
        """
        return: age, code, position, ins, segmentation, mask, label
        """
        # extract data
        ...
        return torch.LongTensor(code), torch.LongTensor(age), torch.LongTensor(gender), torch.LongTensor(
            ethnicity), torch.LongTensor(ins), \
